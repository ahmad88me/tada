...
\usepackage{hyperref} % to make citation clickable
\usepackage{color}
\usepackage{listings}
\usepackage{graphicx}
\usepackage{soul} % for the st
...
%didn't know their answers.
%So we can link it together and can ask complex questions that we didn't know the answer of it before. %and make the most out of it.
